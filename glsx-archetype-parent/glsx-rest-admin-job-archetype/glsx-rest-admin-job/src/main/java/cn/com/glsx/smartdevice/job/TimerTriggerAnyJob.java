...
@Slf4j
@Component
@ElasticSimpleJob(jobName = "TimerTriggerAnyJob", cron = "0/10 * * * * ?")
public class TimerTriggerAnyJob implements SimpleJob {
    @Autowired
    ...
    public void execute(ShardingContext shardingContext) {
        ...
        //定时每10秒执行
        sceneComponent.execute(Condition.ANY_MATCH.getCode());
    }
}
