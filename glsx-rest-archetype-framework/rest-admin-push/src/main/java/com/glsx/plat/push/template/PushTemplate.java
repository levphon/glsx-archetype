...
public class PushTemplate {
     ...
     * @return
     */
    public static LinkTemplate getLinkTemplate(Notify notify) {
...
//        template.setDuration("2019-07-09 11:40:00", "2019-07-09 12:24:00");  // 设置定时展示时间，安卓机型可用
    ...
    private static APNPayload getDictionaryAlertMsgAPNPayload(Notify notify, JSONObject paramJson) {
        //ios处理通知消息
        APNPayload payload = new APNPayload();
        //在已有数字基础上加1显示，设置为-1时，在已有数字上减1显示，设置为数字时，显示指定数字
        payload.setAutoBadge("+1");
